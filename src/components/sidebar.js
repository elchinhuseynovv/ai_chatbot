export function initializeSidebar() {
  ...
  sidebar.innerHTML = `
    ...
    <div class="relative mb-4">
      <input
        ...
        class="w-full bg-gray-700 text-white placeholder-gray-400 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500"
      />
    ...
    <div id="context-menu" class="hidden fixed bg-gray-700 rounded-lg shadow-lg py-1 w-48">
      ...
      <button class="w-full px-4 py-2 text-left hover:bg-gray-600 flex items-center gap-2 text-red-400" data-action="delete">
        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  app.style.marginLeft = '16rem'; // 256px (w-64) in rem
}